...
description: Preserve an intentionally incomplete OpenSpec change without claiming completion or syncing specs. Use ONLY when the owner names OpenSpec abandon. Do not use for ordinary incomplete work.
license: MIT
---
...
Return `Preserved as abandoned-incomplete`, the archive target, owner reason, remaining tasks, and unsynchronized main specs.
