...
- On a real user-owned blocker (not process counters), offer 2-4 product/consequence actions via `question` when available unless questions are disabled; never offer a bare retry, replacement specialist launch, or budget extension.
