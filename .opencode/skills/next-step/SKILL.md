...
- Surface completed-but-not-retroed OpenSpec changes as available work when implementation tasks are done but `Retrospective Before Archive`, `retro.md`, or `openspec:retro-gate` evidence is missing.
