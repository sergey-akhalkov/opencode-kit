...
description: Archive a completed OpenSpec change after verifying tasks, specs, tests, validation, reviewer evidence, and residual risks.
license: MIT
---
...
- Unresolved follow-ups are completed, explicitly out of scope with reason, or returned as `Actionable Continuation Items`; do not hide blockers as completed tasks.
