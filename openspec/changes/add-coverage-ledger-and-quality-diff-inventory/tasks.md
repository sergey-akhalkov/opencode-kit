...
- [ ] Write `openspec/changes/add-coverage-ledger-and-quality-diff-inventory/automation/retro.json` with evidence, problems, root causes, improvements, follow-up ids, and archive gate decision.
