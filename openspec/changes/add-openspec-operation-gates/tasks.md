...
- [ ] Add `propose` gate tests for safe id, required artifacts, spec delta, duplicate id, test-first tasks, and Markdown retro tail.
...
- [ ] Add `task-update` gate tests for checkbox evidence, validation evidence, final Markdown retro tail preservation, and all-checked active change warnings/blockers.
...
- [ ] Add `archive` gate tests for complete tasks, `retro.md`, follow-up ids, freshness, and OpenSpec validation.
...
- [ ] Reuse existing validators: `openspec validate`, repository checks, freshness checks, and Markdown retro gate.
...
- [ ] `propose`: validate `proposal.md`, `tasks.md`, spec deltas, safe id, and Markdown retro task tail.
...
- [ ] `archive`: validate Markdown retro, follow-ups, freshness, and OpenSpec validation.
...
- [ ] Write `openspec/changes/add-openspec-operation-gates/retro.md` with evidence, problems, root causes, improvements, follow-up ids, and archive gate decision.
