...
- [x] Write `openspec/changes/improve-autopilot-runtime-e2e-harness/automation/retro.json` with evidence, problems, root causes, improvements, and archive gate decision.
