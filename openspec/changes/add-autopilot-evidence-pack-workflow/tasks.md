...
- [x] Write `openspec/changes/add-autopilot-evidence-pack-workflow/automation/retro.json` with evidence, problems, root causes, improvements, and archive gate decision.
