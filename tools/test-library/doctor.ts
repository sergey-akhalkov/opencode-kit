...
Optional reviewers may run after current proof for concrete risk, project policy, or owner request; their absence is not a stage blocker. Triggered fresh SDET returns critical-risks-reported | no-critical-risk | blocked. A failed live/external invocation is finalized and must not be repeated unchanged; inspect its status, stdout/stderr, errors, effects, and cleanup, then change mechanism or stop at the exact blocked boundary. No SDET attempt count permanently prohibits future risk assessment of a materially changed candidate.
...
### 3. Critical SDET
SDET returns Action: critical-risks-reported | no-critical-risk | blocked. The invocation remains finalized and non-reusable. Another authorized attempt requires a causal mechanism change or the exact missing observation. No SDET attempt count permanently prohibits future risk assessment of a materially changed candidate.
  ...
  },
  {
    ...
    run: () => {
      const cases = [
        ...
        { name: "agents-missing-invocation-safety", relative: "AGENTS.md", text: conformingAgentsAuthority.replace("failed live/external invocation is finalized and must not be repeated unchanged", "failed live/external invocation may be reused"), expected: "missing finalized invocation safety marker" },
        { name: "agents-missing-mission-continuation", relative: "AGENTS.md", text: conformingAgentsAuthority.replace("change mechanism or stop at the exact blocked boundary", "repeat the same mechanism"), expected: "missing evidence-gated mission continuation marker" },
        ...
        { name: "skill-missing-mission-continuation", relative: path.join("skills", "change-ready-sdlc", "SKILL.md"), text: conformingSkillAuthority.replace("Another authorized attempt requires a causal mechanism change or the exact missing observation", "Another authorized attempt repeats the same mechanism"), expected: "missing evidence-gated mission continuation marker" },
